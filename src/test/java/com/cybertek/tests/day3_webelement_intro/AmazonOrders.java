...
public class AmazonOrders {
    public static void main(String[] args) {
        ...
        WebDriver amazon= WebDriverFactory.GetDriver("chrome");
        ...
        enterEmail.sendKeys("eddiebakeruk@gmail.com");
        WebElement clickButtons= amazon.findElement(By.id("continue"));
        clickButtons.click();
        WebElement enterPassword =amazon.findElement(By.name("ap_password"));
